...
## Project overview
This project applies a logistic regression, GLM and Random Forest models to compare the methodologies when forecasting retention in motor insurance.
